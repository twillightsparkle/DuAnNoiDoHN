...
export const noblePalaceTayThangLong: Estate = {
  ...
  overview:
    "Dự án có tổng diện tích đất 77 ha, mật độ xây dựng 30% và tổng 2.448 sản phẩm, gồm nhà phố thương mại, shophouse và các phân khu tinh hoa Legacy, Century, Harmony, Victory.",
  stats: [
    { label: "Quy mô", value: "77 ha" },
    { label: "Mật độ", value: "30%" },
    { label: "Sản phẩm", value: "2.448 căn" },
    { label: "Phân khu", value: "4 khu" },
  ],
  highlights: [
    "Kết hợp kiến trúc châu Âu sang trọng với công nghệ AI trong quản lý đô thị",
    "Loại hình sản phẩm chính là shophouse 4-5 tầng, phục vụ vừa ở vừa kinh doanh",
    "Sở hữu lâu dài, phù hợp dòng sản phẩm hàng hiệu cho thị trường phía Tây Hà Nội",
  ...
  cta: "Khám phá tổng quan dự án, dòng sản phẩm shophouse và vị trí vàng của Noble Palace Tây Thăng Long.",
};